...
const Edit = ({ employees, selectedEmployee, setEmployees, setIsEditing ,setIsAuthenticated }) => {
  ...
  const handleUpdate = e => {
    ...
    Swal.fire({
      icon: 'success',
      title: 'Updated!',
      text: `${employee.firstName} ${!employee.middleName?" ":employee.middleName} ${employee.lastName}'s data has been updated.`,
